...
declare length/checksum, calculate SHA-256 while streaming and enforce a local maximum. Original filenames are
never local destination paths.

Configure local and Control Plane maxima consistently. Multipart resume and
large-artifact offline queuing are outside v0.2.1.
