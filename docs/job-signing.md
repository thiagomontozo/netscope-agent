...
and the signature made over RFC 8785 JCS bytes. It never tries every
...
The canonicalizer accepts finite I-JSON decimals without integer truncation or
string conversion. The shared regression signs `1.25`, round-trips the envelope
and rejects a mutation to `1.26`.
